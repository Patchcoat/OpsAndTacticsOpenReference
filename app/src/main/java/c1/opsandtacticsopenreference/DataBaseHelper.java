...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/c1.opsandtacticsopenreference/databases/";
    ...
    private static String DB_TABLE = "pages";
    ...
    public Cursor search (String searchString) {
        ...
        try {
            if (myDataBase == null) {myDataBase = getReadableDatabase();}
            cursor = myDataBase.query(DB_TABLE, columns, where, whereArgs, null, null, null);
        } catch (Exception e) {
